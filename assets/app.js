(() => {
  ...
  if (localStorage.getItem('ysv-theme') === 'light') root.classList.add('light');
  themeButton?.addEventListener('click', () => { root.classList.toggle('light'); localStorage.setItem('ysv-theme', root.classList.contains('light') ? 'light' : 'dark'); });
